...
class FileIdTest extends MadelineTestCase
{
    ...
    {
        $res = [
            'sticker' => 'https://github.com/blob/master/tests/lel.webp?raw=true',
            'photo' => 'https://github.com/blob/master/tests/faust.jpg',
            'audio' => 'https://github.com/blob/master/tests/mosconi.mp3?raw=true',
            'video' => 'https://github.com/blob/master/tests/swing.mp4?raw=true',
            'animation' => 'https://github.com/blob/master/tests/pony.mp4?raw=true',
